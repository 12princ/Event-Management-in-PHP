...
//        $sql = "SELECT u.name AS user_name, u.address, u.phone, u.email,
//        e.event AS event_name,
//        v.Venue_Name AS venue,
//        p.P_Name AS package
//        FROM tbl_users u
//        JOIN tbl_event e ON u.event_id = e.E_id
//        JOIN tbl_venues v ON e.venue_id = v.V_Id
//        JOIN tbl_package p ON v.package_id = p.P_Id
//        ORDER BY r.id DESC LIMIT $start, $per_page";
